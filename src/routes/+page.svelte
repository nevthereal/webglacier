<div class="flex w-full h-full">
	<div class="flex flex-col text-center m-auto gap-2">
		...
		<a href="/about" class="mx-auto"
			><button
				class="btn py-2 px-4 text-lg font-bold mt-2 bg-primary-500 hover:bg-primary-400 shadow-md hover:shadow-lg shadow-primary-400/50 hover:shadow-primary-300/50 duration-200"
				>Explore</button
			></a
		>
	</div>
